...
| c2.2 | docs | **v2.2 spec patch — GPU device 명시.** §2.1 In-scope Training row + §3.3 The Config Training bullet 에 `device=cuda` (GPU 사용 가능, PyTorch native, plan-012 c18 ff1e578 GPU spec-faithful rerun 인프라 재사용, `torch.cuda.is_available() == True` 가정) 박제. frontmatter version 2.1→2.2 | [TODO] |
